...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate qualitative outputs for Huatuo models')
    ...
    # Define model configurations for Huatuo
    model_configs = {
        'full': {
            'path': 'model/checkpoints/huatuo_full/final',
            'use_lora': False
        },
        'baseline_lora': {
            'path': 'model/checkpoints/huatuo_lora_baseline/final',
            'base_model': 'google/mt5-base',
            'use_lora': True
        },
        'gs_1': {
            'path': 'model/checkpoints/huatuo_lora_gs/huatuo_gs_1_lr5e-04_r16_alpha64_do0.05/final',
            'base_model': 'google/mt5-base',
            'use_lora': True
        },
        'gs_2': {
            'path': 'model/checkpoints/huatuo_lora_gs/huatuo_gs_2_lr5e-04_r24_alpha96_do0.05/final',
            'base_model': 'google/mt5-base',
            'use_lora': True
        },
        'gs_3': {
            'path': 'model/checkpoints/huatuo_lora_gs/huatuo_gs_3_lr3e-04_r16_alpha64_do0.05/final',
            'base_model': 'google/mt5-base',
            'use_lora': True
        },
        'gs_4': {
            'path': 'model/checkpoints/huatuo_lora_gs/huatuo_gs_4_lr5e-04_r8_alpha32_do0.05/final',
            'base_model': 'google/mt5-base',
            'use_lora': True
        }
    }
